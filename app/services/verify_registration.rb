...
module TrackIt
  ...
  class VerifyRegistration
    ...
    def html_email
      <<~END_EMAIL
        <H1>TrackIt App Registration Received</H1>
        <p>Please <a href=\"#{@registration[:verification_url]}\">click here</a>
        to validate your email.
        You will be asked to provide further information to activate your account.</p>
      END_EMAIL
    end
    ...
    def mail_json # rubocop:disable Metrics/MethodLength
      {
        ...
        subject: 'TrackIt Registration Verification',
        content: [
          { type: 'text/html',
            value: html_email }
        ]
