...
describe 'Test Account Handling' do
  ...
  describe 'Account Information' do
    it 'HAPPY: should be able to get details about a single account' do
      ...
      _(attributes['first_name']).must_equal account.first_name
      _(attributes['last_name']).must_equal account.last_name
